      ...
      <div className="relative z-10 max-w-300 mx-auto px-6 w-full">
        <div className="max-w-150 text-left">
          ...
          <p className="text-white/90 text-lg md:text-xl mb-10 max-w-125 font-body">
            ...
            Disfrutá la mejor ubicación de Santa Teresita con todo el confort que merecés.
          </p>

          <div className="flex flex-wrap gap-4">
            <a href="#departamentos" className="bg-gold hover:bg-gold-dark text-white px-8 py-4 rounded-full font-bold uppercase tracking-widest transition-colors">
              Ver Departamentos
            </a>
            <a href="https://wa.me/5491169603403" target="_blank" rel="noopener noreferrer" className="border-2 border-white text-white hover:bg-white/10 px-8 py-4 rounded-full font-bold uppercase tracking-widest transition-colors">
              Consultar
            </a>
          </div>
        </div>
